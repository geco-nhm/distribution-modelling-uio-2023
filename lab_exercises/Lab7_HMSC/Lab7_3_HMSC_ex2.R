...
#If you want more exercises (with spatial & temporal random effects, hurdle models and more), you can run
#one of the "Executable scripts" on the HMSC web page: https://www2.helsinki.fi/en/researchgroups/statistical-ecology/hmsc
