...
#from code originally created by Jacob Levine and Perry de Valpine
...
##IS A psi ESTIMATE CALCULATED THIS WAY BIASED IN A PARTICULAR DIRECTION? WHAT ABOUT p?
  #Type your thoughts here:
    # https://docs.google.com/spreadsheets/d/1LY0X0Yru0EM8HHuyORT5ycrIU_Jb3GPfE1RNjjdHUys/edit?usp=sharing 
...
plot(psiR, col=mapPalette(100), main="Willow tit occupancy (ignoring ", axes=FALSE, box=FALSE)
